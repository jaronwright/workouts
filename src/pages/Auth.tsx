                      ...
                      <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <div
                            ...
                            className={`
                              w-[18px] h-[18px] rounded-[var(--radius-sm)] flex-shrink-0
                              flex items-center justify-center cursor-pointer
                              transition-all duration-150
                              ${rememberMe
                                ? 'bg-[var(--color-primary)] border-[var(--color-primary)]'
                                : 'bg-[var(--color-surface-sunken)] border-2 border-[var(--color-border-strong)]'
                              }
                            `}
                          >
                            {rememberMe && (
                              <svg className="w-3 h-3" style={{ color: 'var(--color-primary-text)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
